...
from .trainaugmentation import TrainAugmentation
from .testaugmentation import TestAugmentation
...
class Data():
  ...
  def __init__(self):
    self.train_album = TrainAugmentation()
    self.test_album = TestAugmentation()
