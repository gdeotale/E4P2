...
def get_prediction(image_bytes):
    ...
    in_mem_file.seek(0)
    s3.Object('gdeotale-session8-sr', 'sr.jpg').put(Body=in_mem_file,ContentType='image/JPG', ACL='public-read')
    url = "https://{}.s3.amazonaws.com/{}".format('gdeotale-session8-sr', 'sr.jpg')
...
def get_sr(event, context):
    try:
        ...
        return {
            ...
            "body": json.dumps({'file': "Super Image: ", 'image URL':prediction})
        }
